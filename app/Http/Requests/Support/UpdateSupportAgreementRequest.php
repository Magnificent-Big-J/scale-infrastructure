...
class UpdateSupportAgreementRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'code' => ['required', 'string', 'max:64', Rule::unique('support_agreements', 'code')->ignore($this->route('supportAgreement'))],
