...
class UpdateSupportTierRequest extends FormRequest
{
    ...
    {
        $supportTierId = $this->route('supportTier')?->getKey();

        return [
            'code' => ['sometimes', 'string', 'max:64', Rule::unique('support_tiers', 'code')->ignore($supportTierId)],
